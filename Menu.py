...
def play(GSTATE, GAMEMODE, AI_Depth):
    while True:
        ChessMain.GameStart(screen,GAMEMODE,AI_Depth,GSTATE, color1, color2)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if OPTIONS_Level1.checkForInput(OPTIONS_MOUSE_POS):
                    GAMEMODE = 1
                    AI_Depth = 2
                    ChessMain.GameStart(screen,GAMEMODE, AI_Depth, None, color1, color2)
